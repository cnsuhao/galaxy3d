...
namespace Galaxy3D
{
	...
	public:
		...
		static std::shared_ptr<Texture2D> CreateWithData(char *data, int size, FilterMode::Enum filter_mode = FilterMode::Bilinear, TextureWrapMode::Enum wrap_mode = TextureWrapMode::Clamp, bool mipmap = false);
		//cached by file name
